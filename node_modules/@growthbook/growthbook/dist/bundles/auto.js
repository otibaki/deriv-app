var _growthbook = (function () {
  ...
  function getAutoAttributes(dataContext, windowContext) {
  ...
  function getAttributes() {
    ...
    const attributes = dataContext["noAutoAttributes"] ? {} : getAutoAttributes(dataContext, windowContext);
  ...
  const gb = new GrowthBook({
    ...
    trackingCallback: async (e, r) => {
      ...
      if (windowContext.additionalTrackingCallback) {
        promises.push(Promise.resolve(windowContext.additionalTrackingCallback(e, r)));
      }
