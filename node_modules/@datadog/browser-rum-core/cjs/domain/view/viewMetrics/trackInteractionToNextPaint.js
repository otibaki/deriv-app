...
var interactionSelectorCache_1 = require("../../action/interactionSelectorCache");
...
function trackInteractionToNextPaint(configuration, viewStart, viewLoadingType) {
    ...
    var firstInputSubscription = (0, performanceObservable_1.createPerformanceObservable)(configuration, {
        type: performanceObservable_1.RumPerformanceEntryType.FIRST_INPUT,
        buffered: true,
    }).subscribe(handleEntries);
    var eventSubscription = (0, performanceObservable_1.createPerformanceObservable)(configuration, {
