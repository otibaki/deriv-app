...
function injectHeadersIfTracingAllowed(configuration, context, sessionManager, inject) {
    ...
    var traceId = (0, identifier_1.createTraceIdentifier)();
    context.traceSampled =
        !(0, browser_core_1.isNumber)(configuration.traceSampleRate) || (0, sampler_1.isTraceSampled)(traceId, configuration.traceSampleRate);
...
function makeTracingHeaders(traceId, spanId, traceSampled, propagatorTypes) {
    ...
    propagatorTypes.forEach(function (propagatorType) {
        switch (propagatorType) {
            ...
            case 'tracecontext': {
                (0, browser_core_1.assign)(tracingHeaders, {
                    traceparent: "00-0000000000000000".concat((0, identifier_1.toPaddedHexadecimalString)(traceId), "-").concat((0, identifier_1.toPaddedHexadecimalString)(spanId), "-0").concat(traceSampled ? '1' : '0'),
                });
                break;
            }
            ...
            case 'b3': {
                (0, browser_core_1.assign)(tracingHeaders, {
                    b3: "".concat((0, identifier_1.toPaddedHexadecimalString)(traceId), "-").concat((0, identifier_1.toPaddedHexadecimalString)(spanId), "-").concat(traceSampled ? '1' : '0'),
                });
                break;
            }
            case 'b3multi': {
