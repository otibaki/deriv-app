 ...
 * The configuration of each currency.
 */
export interface CurrencyConfigStructure8 {
  [k: string]: unknown;
}
/**
...
export interface Mt5GetSettings {
   ...
   * Sub account type
   */
  sub_account_type?: "derivez" | "financial" | "financial_stp" | "standard";
  /**
   * User's zip code.
   */
  zipCode?: string;
...
export interface DetailsOfEachMT5Loginid {
   ...
   * Sub account category
   */
  sub_account_category?: "" | "swap_free" | "swap_free_high_risk" | "ibt" | "stp" | "lim";
  /**
  ...
  white_label?: {
    ...
    /**
     * A flag indicating whether the white label notification feature is enabled or disabled.
     */
...
export interface MT5NewAccountRequest {
   ...
   */
  server?: null | ("p01_ts01" | "p01_ts02" | "p01_ts03" | "p01_ts04" | "p02_ts02" | "p03_ts01");
  /**
   ...
   */
  sub_account_category?: "swap_free" | "swap_free_high_risk";
  /**
...
export interface P2PAdvertCreate {
   ...
   */
  order_expiry_period: 900 | 1800 | 2700 | 3600 | 5400 | 7200;
  /**
...
export interface DetailsOfEachServer {
   ...
   * Server unique id.
   */
  id?: "p01_ts01" | "p01_ts02" | "p01_ts03" | "p01_ts04" | "p02_ts02" | "p03_ts01";
  /**
   * Market type
   */
  market_type?: string;
 ...
 */
export interface VerifyEmailCellxpertResponse {
 ...
 */
export interface VerifyEmailCellxpertRequest {
  /**
