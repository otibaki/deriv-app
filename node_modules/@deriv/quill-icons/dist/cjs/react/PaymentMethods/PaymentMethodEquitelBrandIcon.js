...
const PaymentMethodEquitelBrandIcon = ({ title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 128 80', role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    ...
    React.createElement("path", { fill: 'url(#d7a18ba9afe784c24534a563c869eaef__a)', d: 'M94.319 35.915a8.444 8.444 0 0 0 8.443-8.444 8.443 8.443 0 1 0-16.887 0 8.444 8.444 0 0 0 8.444 8.444' }),
    React.createElement("path", { fill: 'url(#d7a18ba9afe784c24534a563c869eaef__b)', d: 'M115.556 35.915A8.444 8.444 0 0 0 124 27.47a8.444 8.444 0 1 0-8.444 8.444' }),
    React.createElement("path", { fill: 'url(#d7a18ba9afe784c24534a563c869eaef__c)', d: 'M72.95 35.915a8.444 8.444 0 1 0 0-16.888 8.444 8.444 0 0 0 0 16.888' }),
    ...
    React.createElement("path", { fill: 'url(#d7a18ba9afe784c24534a563c869eaef__d)', d: 'M72.931 35.88a8.444 8.444 0 1 0 0-16.887 8.444 8.444 0 0 0 0 16.888' }),
    React.createElement("path", { fill: 'url(#d7a18ba9afe784c24534a563c869eaef__e)', d: 'M94.3 35.88a8.444 8.444 0 1 0 0-16.888 8.444 8.444 0 0 0 0 16.888' }),
    React.createElement("path", { fill: 'url(#d7a18ba9afe784c24534a563c869eaef__f)', d: 'M115.537 35.88a8.444 8.444 0 0 0 8.444-8.443 8.444 8.444 0 1 0-8.444 8.444' }),
    ...
    React.createElement("defs", null,
        React.createElement("radialGradient", { id: 'd7a18ba9afe784c24534a563c869eaef__a', cx: 0, cy: 0, r: 1, gradientTransform: 'rotate(16.984 -81.976 172.14)scale(69.9605 43.9313)', gradientUnits: 'userSpaceOnUse' },
        ...
        React.createElement("radialGradient", { id: 'd7a18ba9afe784c24534a563c869eaef__b', cx: 0, cy: 0, r: 1, gradientTransform: 'rotate(16.984 -81.976 172.14)scale(69.9605 43.9313)', gradientUnits: 'userSpaceOnUse' },
        ...
        React.createElement("radialGradient", { id: 'd7a18ba9afe784c24534a563c869eaef__c', cx: 0, cy: 0, r: 1, gradientTransform: 'rotate(16.984 -81.976 172.14)scale(69.9605 43.9313)', gradientUnits: 'userSpaceOnUse' },
            React.createElement("stop", { stopColor: '#F79624', stopOpacity: 0.33 }),
            React.createElement("stop", { offset: 0.258, stopColor: '#F79624' }),
            React.createElement("stop", { offset: 0.79, stopColor: '#F79624' })),
        React.createElement("radialGradient", { id: 'd7a18ba9afe784c24534a563c869eaef__d', cx: 0, cy: 0, r: 1, gradientTransform: 'matrix(9.4163 8.21422 -9.1463 10.48478 70.498 24.001)', gradientUnits: 'userSpaceOnUse' },
            React.createElement("stop", { stopColor: '#FFCA8B' }),
            React.createElement("stop", { offset: 0.258, stopColor: '#F79624' }),
            React.createElement("stop", { offset: 0.79, stopColor: '#F79624' })),
        React.createElement("radialGradient", { id: 'd7a18ba9afe784c24534a563c869eaef__e', cx: 0, cy: 0, r: 1, gradientTransform: 'matrix(9.4163 8.21422 -9.1463 10.48478 91.866 24.001)', gradientUnits: 'userSpaceOnUse' },
            React.createElement("stop", { stopColor: '#FFCA8B' }),
            React.createElement("stop", { offset: 0.258, stopColor: '#F79624' }),
            React.createElement("stop", { offset: 0.79, stopColor: '#F79624' })),
        React.createElement("radialGradient", { id: 'd7a18ba9afe784c24534a563c869eaef__f', cx: 0, cy: 0, r: 1, gradientTransform: 'matrix(9.4163 8.21422 -9.1463 10.48478 113.104 24.001)', gradientUnits: 'userSpaceOnUse' },
